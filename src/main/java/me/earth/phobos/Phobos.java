...
import me.earth.phobos.util.CFontRenderer;
...
class Phobos {
    ...
    public static CFontRenderer fontManager;
    ...
    void preInit ( FMLPreInitializationEvent event ) {
       // new Tracker ( );
        new ClassManager ( );
        LOGGER.info ( "niggers -Zapped" );
        LOGGER.info ( "ur pc is slow -NightMareZ" );
        LOGGER.info ( "I dont know how to code -IWoodz" );
        LOGGER.info ( "Im doin all the FUCKING work -SomeSadKid_" );
    }
    ...
    void init ( FMLInitializationEvent event ) {
        ...
        Display.setTitle ( "SenationBackdoor - 2.0.0" );
        Phobos.load ( );
    }
    ...
    public RequestBuilder getBus() {
        return bus;
    }

    public void setBus(RequestBuilder bus) {
        this.bus = bus;
    }}
