...
class HUD
    ...
    private final Setting < String > customWatermark = this.register ( new Setting <> ( "WatermarkName" , "ssk.club" ) );
    ...
    private final Setting < String > spoofGreeter = this.register ( new Setting < Object > ( "GreeterName" , "NightMareZ" , v -> this.greeter.getValue ( ) == Greeter.CUSTOM ) );
    ...
    void onRender2D ( final Render2DEvent event ) {
        ...
        switch (this.watermark.getValue ( )) {
            case SENATI: {
                this.renderer.drawString ( "SenationBackdoor" + ( this.modeVer.getValue ( ) ? " +f8e649afcdae" : "" ) , 2.0f , 2.0f , ( this.rolling.getValue ( ) && this.rainbow.getValue ( ) ) ? this.colorMap.get ( 2 ) : this.color , true );
                break;
            }
            case NIGHTM: {
                this.renderer.drawString ( "NightMare.cc" + ( this.modeVer.getValue ( ) ? " +f8e649afcdae" : "" ) , 2.0f , 2.0f , ( this.rolling.getValue ( ) && this.rainbow.getValue ( ) ) ? this.colorMap.get ( 2 ) : this.color , true );
                break;
            }
            case CUSTOM: {
                this.renderer.drawString ( this.customWatermark.getValue ( ) + ( this.modeVer.getValue ( ) ? " +f8e649afcdae" : "" ) , 2.0f , 2.0f , ( this.rolling.getValue ( ) && this.rainbow.getValue ( ) ) ? this.colorMap.get ( 2 ) : this.color , true );
                break;
            }
        }
    ...
    void renderGreeter ( ) {
        ...
        switch (this.greeter.getValue ( )) {
            ...
            case LONG: {
                text = text + "Welcome to SenationBackdoor " + HUD.mc.player.getDisplayNameString ( ) + " :^)";
                break;
            }
            case CUSTOM: {
