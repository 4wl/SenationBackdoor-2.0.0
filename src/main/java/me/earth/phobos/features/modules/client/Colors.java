...
import static me.earth.phobos.features.modules.client.ClickGui.getInstance;
...
class Colors
    ...
    void onTick ( ) {
        ...
        if (HUD.INSTANCE.colorSync.getValue ( ) ) {
            Phobos.colorManager.setColor ( INSTANCE.getCurrentColor ( ).getRed ( ) , INSTANCE.getCurrentColor ( ).getGreen ( ) , INSTANCE.getCurrentColor ( ).getBlue ( ) , getInstance ( ).hoverAlpha.getValue ( ) );
        }
    }
