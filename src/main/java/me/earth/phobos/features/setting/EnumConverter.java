...
class EnumConverter
    ...
    public static
    int currentEnum ( Enum < me.earth.phobos.features.modules.combat.Offhand.Mode2 > clazz ) {
    ...
    public static
    Enum increaseEnum ( Enum < me.earth.phobos.features.modules.combat.Offhand.Mode2 > clazz ) {
    ...
    public static
    String getProperName ( Enum < me.earth.phobos.features.modules.combat.Offhand.Mode2 > clazz ) {
