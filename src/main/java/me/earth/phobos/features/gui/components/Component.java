...
implements Util {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRect(this.x - 4, this.y - 2, this.x + this.width + 4, this.y + this.height - 6, new Color((Integer) ClickGui.getInstance().categoryRed.getValue(), (Integer) ClickGui.getInstance().categoryGreen.getValue(), (Integer) ClickGui.getInstance().categoryBlue.getValue(), (Integer) ClickGui.getInstance().categoryAlpha.getValue()).getRGB());
        if (this.open) {
        ...
        Phobos.fontManager.drawString(this.getName(), (float)this.x + (float)this.width / 2.0f - (float)(Phobos.fontManager.getStringWidth(this.getName()) / 2), (float)this.y - 4.0f - (float)PhobosGui.getClickGui().getTextOffset(), 0xFFFFFF);
        if (this.open) {
