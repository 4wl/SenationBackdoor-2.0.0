...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Phobos.fontManager.drawString(this.getName() + " " + ChatFormatting.GRAY + (this.setting.getValue() instanceof Float ? (Number)((Number)this.setting.getValue()) : (Number)((Number)this.setting.getValue()).doubleValue()), this.x + 2.0f, this.y - 1.0f - (float)PhobosGui.getClickGui().getTextOffset(), -1);
    }
