...
class DiscordPresence {
    ...
    void start ( ) {
        ...
        rpc.Discord_Initialize ( "973437985376841728" , handlers , true , "" );
        ...
        DiscordPresence.presence.largeImageKey = "senation";
        DiscordPresence.presence.largeImageText = "SenationBackdoor";
        ...
        thread = new Thread ( ( ) -> {
            while ( ! Thread.currentThread ( ).isInterrupted ( ) ) {
                ...
                if ( RPC.INSTANCE.catMode.getValue ( ) ) {
                    ...
                    DiscordPresence.presence.largeImageKey = "senation" + index;
                    ++ index;
                }
                rpc.Discord_UpdatePresence ( presence );
                try {
