...
import me.earth.phobos.features.modules.autocrystals.*;
...
class ModuleManager
    ...
    void init ( ) {
      ...
      //this.modules.add ( new Flight ( ) );
       //his.modules.add ( new ElytraFlight ( ) );
     ...
     // this.modules.add ( new NoHunger ( ) );
      ...
      //this.modules.add ( new ArrowESP ( ) );
       ...
       //his.modules.add ( new PhobosChat ( ) );
